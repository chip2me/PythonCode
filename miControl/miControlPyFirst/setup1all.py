...
def InitPars ():
   ...
   Sp(0x3210, 0x00, 100)              # CURR_Kp
   Sp(0x3211, 0x00, 100)              # CURR_Ki

   Sp(0x3224, 0x00, 0)                # CURR_DynLimitMode
   Sp(0x3224, 0x01, 2000)             # CURR_DynLimitPeak
   Sp(0x3224, 0x02, 2000)             # CURR_DynLimitCont
   ...
   Sp(0x3341, 0x00, 1000)             # VEL_Acc_dT
   Sp(0x3342, 0x00, 1000)             # VEL_Dec_dV
   Sp(0x3343, 0x00, 1000)             # VEL_Dec_dT
