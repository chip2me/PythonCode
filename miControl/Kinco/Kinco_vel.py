...
#*---------------------------------------------------------------------------*#
#* Customer : Kinco                                                          *#
#* Name     : Ib Lundgaard, Søren O. Sloth                                  *#
#* OrderNr. :                                                                *#
...
if not PYMC:
   SpGp_NodeId(1)                # NodeId des Geräts für Sp()/Gp() Funktionen festlegen (für Simulation)
   Sp(0x5000,0, 3)               # evtl. vorhandenes MPU2-Programm auf dem Gerät anhalten (stört sonst Simulation)
