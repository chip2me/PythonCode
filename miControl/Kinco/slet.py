...
def InitPars ():
   ...
   Sp(0x39a0, 0x00, 3)                # MOTOR_BrakeManagement_Config
   ...
   Sp(0x39a0, 0x10, 100)              # MOTOR_BrakeManagement_OffDelay1
   Sp(0x39a0, 0x11, 200)              # MOTOR_BrakeManagement_OffDelay2
   Sp(0x39a0, 0x12, 300)              # MOTOR_BrakeManagement_OnDelay1
   Sp(0x39a0, 0x13, 400)              # MOTOR_BrakeManagement_OnDelay2
   Sp(0x39a0, 0x18, 223)              # MOTOR_BrakeManagement_OffOrConditionFlags
   Sp(0x39a0, 0x19, 0)                # MOTOR_BrakeManagement_OffAndConditionFlags
   Sp(0x39a0, 0x1a, 255)              # MOTOR_BrakeManagement_OnOrConditionFlags
